...
<p style='font-family: helvetica, sans-serif; line-height: 24px; font-size: 16px;'>
<strong>{{ $classroom->user->pretty_name() }}</strong> invited you to join Classrr.
</p>
<p style='font-family: helvetica, sans-serif; line-height: 24px; font-size: 16px;'>
<table border='0' cellpadding='0' cellspacing='0' class='table' width='100%'>
<tr>
<td style='padding: 0 15px 0 0; font-size: 10px; vertical-align:top;' width='90'>
<img alt="{{ $classroom->user->pretty_name() }}" border="0" height="45" src="{{ $classroom->user->avatar() }} " style="width: 90px; height: 90px; border-radius: 50%" width="45" />
</td>
...
<p style='font-family: helvetica, sans-serif; line-height: 24px; font-size: 16px;'>
Join {{ $classroom->user->first_name }} and 1,000,000+ teachers &amp; students using Classrr to learn new skills, exchange knowledge, book classes, and find jobs.
</p>
<p style='font-family: helvetica, sans-serif; line-height: 24px; font-size: 16px;'>
...
<a href="{{ url('/') }}" style="color: #ffffff; font-size: 16px; font-family: helvetica, sans-serif; text-decoration: none; width: 100%; display: inline-block; line-height: 40px; height: 40px;">Accept Your Invitation</a>
</td>
</tr>
</table>
