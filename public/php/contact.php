...
$address = "contact@teachinclass.com";
...
$userheaders = "From: contact@teachinclass.com\n";
$usermessage = "Thank you for contacting our support. We will reply shortly!";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "Thank you <strong>$name_contact</strong>,<br> your message has been sent. We will contact you shortly.";
	echo "</div>";

} else {

	echo 'ERROR! Please try sending directly to contact@classrr.com. Sorry for any inconvenience.';
